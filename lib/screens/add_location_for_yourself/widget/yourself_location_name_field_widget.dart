...
class YourselfLocationNameFieldWidget extends StatelessWidget {
  const YourselfLocationNameFieldWidget({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText: constCtr.strings.locationName,
